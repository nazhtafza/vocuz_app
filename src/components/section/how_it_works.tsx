  ...
  const steps = [
    {
      ...
      icon: <ListTodo className="w-5 h-5 md:w-6 md:h-6 text-white" />,
    },
    {
      ...
      icon: <Play className="w-5 h-5 md:w-6 md:h-6 text-white fill-white" />,
    },
    {
      ...
      icon: <Coffee className="w-5 h-5 md:w-6 md:h-6 text-white" />,
    },
    {
      ...
      icon: <TreePalm className="w-5 h-5 md:w-6 md:h-6 text-white" />,
    },
    {
      ...
      icon: <ChartArea className="w-5 h-5 md:w-6 md:h-6 text-white" />,
    },
  ];
    ...
    <>
      <section id="works" className="relative w-full py-20 overflow-hidden bg-white">
        <div className="text-center items-center px-4">
          <h1 className="font-bold text-3xl md:text-4xl text-center items-center">
            How It Works
          </h1>
          <p className="font-medium text-lg md:text-xl text-center text-gray-500 items-center mt-4">
        ...
        <div className="container mx-auto px-4 relative z-10 mt-11">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-slate-300 transform -translate-x-1/2" />
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* tampilkan di sisi kiri jika dict-genap */}
                  <div
                    className={cn(
                      "w-1/2 pr-8 md:pr-12",
                      isEven ? "text-right block" : "invisible"
                    )}
                  >
                    <h3 className="text-lg md:text-2xl font-bold text-slate-900 mb-2">
                      {step.title}
                    </h3>
                    <p className="text-slate-600 leading-relaxed font-medium text-xs md:text-base lg:text-base">
                      {step.description}
                    </p>
                  </div>
                  <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#111625] shadow-lg z-10 border-4 border-white">
                    {step.icon}
                  </div>
                  {/* menampilkan di kanan apabila dict-nya adalah ganjil */}
                  <div
                    className={cn(
                      "w-1/2 pl-8 md:pl-12",
                      !isEven ? "text-left block" : "invisible"
                    )}
                  >
                    <h3 className="text-lg md:text-2xl font-bold text-slate-900 mb-2">
                      {step.title}
